...
function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 pb-24 bg-black text-white">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-5 left-1/2 -translate-x-1/2 text-sm px-4 py-2 rounded-full"
        style={{
          color: 'var(--muted)',
